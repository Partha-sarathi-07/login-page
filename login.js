...
function showEmailError() {
    ...
    dom_references.email_error_text.classList.add("invalid");
    dom_references.email_error_text.classList.remove("valid");
}


function hideEmailError() {
    dom_references.email_input_field.classList.remove("error-border");
    dom_references.email_error_text.classList.remove("invalid");
    dom_references.email_error_text.classList.add("valid");
}
...
function showLoginError() {
    dom_references.invalidCredentials.classList.add("invalid");
}   


function hideLoginError() {
    dom_references.invalidCredentials.classList.remove("invalid");
}